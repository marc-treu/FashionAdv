...
python evaluate_robustness.py --compression --qf_range 10 100

# Test against image manipulations
python evaluate_robustness.py --manipulations --mode hard

# Full evaluation suite
python evaluate_robustness.py --full
```

### Naturalness Assessment
```python
# Compute SSIM scores
python evaluate_naturalness.py --metric ssim

# Human perceptual study
python evaluate_naturalness.py --human_study
```
...
```bash
# Create attack comparison figure
python visualize_attacks.py --methods fgsm colorfool cadv tadv fashionadv

# Generate robustness plots
python plot_robustness.py --output results/robustness_plot.png
```

## 🔬 Ablation Studies

Reproduce our ablation studies:
```bash
# Loss component analysis
python ablation_loss.py

# Style selection strategy comparison
python ablation_style.py

# Robustness training effectiveness
